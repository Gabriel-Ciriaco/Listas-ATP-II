...
int encontrar_terceiro_maior(int matriz[LARGURA][ALTURA]);
...
int main()
{
    ...
    printf("O terceiro maior elemento eh: %d",
           encontrar_terceiro_maior(matriz));
...
int encontrar_terceiro_maior(int matriz[LARGURA][ALTURA])
{
    ...
    // Retornar o terceiro maior elemento.
    return ord_vect[(LARGURA * ALTURA) - 3];
